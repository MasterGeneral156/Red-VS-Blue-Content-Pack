...
import com.themastergeneral.redvblue.*;
...
public MusicDisc(int par1, String par0Str)
{
super(par0Str);
...
{
return new ResourceLocation("redvblue:" + name);
}

@SideOnly(Side.CLIENT)
public void registerIcons(IIconRegister iconRegister)
{
this.itemIcon = iconRegister.registerIcon("redvblue:" + this.getUnlocalizedName().substring(5));
}
}