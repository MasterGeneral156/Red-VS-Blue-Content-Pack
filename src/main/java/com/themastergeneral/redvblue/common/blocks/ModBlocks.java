...
public class ModBlocks extends RegisterBlock
{
	...
	{
		blue_aligned_brick = register(new BasicBlock(Material.GROUND, "blue_aligned_brick", RedVBlue.MODID));
		blue_french_brick = register(new BasicBlock(Material.GROUND, "blue_french_brick", RedVBlue.MODID));
		red_aligned_brick = register(new BasicBlock(Material.GROUND, "red_aligned_brick", RedVBlue.MODID));
		red_french_brick = register(new BasicBlock(Material.GROUND, "red_french_brick", RedVBlue.MODID));
	}
}
